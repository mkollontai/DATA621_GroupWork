...
kable(cor_train_target, digits = 3) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"),latex_options="scale_down")
```
...
metrics <- data.frame(Accuracy, CER, Precision, Sensitivity, Specificity, F1)
