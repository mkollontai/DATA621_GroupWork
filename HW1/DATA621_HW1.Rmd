...
```{r}
include <- c('INDEX', 'TEAM_BATTING_3B', 'TEAM_BATTING_HR', 'TEAM_BATTING_BB', 'TEAM_BASERUN_SB', 'TEAM_PITCHING_H',  'TEAM_PITCHING_BB', 'TEAM_FIELDING_E')
test_sub <- MB_test[include] 
test_sub$P_Wins <- round(predict(mod4,  newdata = MB_test),0)
test_sub[c('INDEX','P_Wins')]
```